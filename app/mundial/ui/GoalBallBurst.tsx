...
function SoccerBall({ gradientId }: { gradientId: string }) {
  return (
    <svg
    ...
    >
      <defs>
        <radialGradient id={gradientId} cx="35%" cy="32%" r="68%">
      ...
      />
      <path fill="#1a1a1a" d="M50 34 L58 42 L54 52 L46 52 L42 42 Z" />
      <path
        fill="none"
        stroke="#1a1a1a"
        strokeWidth="1.2"
      ...
      <div className={styles.stageShake}>
        <div className={styles.stage}>
          ...
          <div className={styles.ballWrap}>
            ...
            <SoccerBall gradientId={gradientId} />
          </div>
        </div>
      </div>
      {scorerLabel ? (
